...
from database.crud import (
    ...
    get_latest_price, get_latest_availability,  # <-- ДОБАВЛЕНО get_latest_availability
    create_notification, save_price,
...
async def share_station(callback: CallbackQuery):
    ...
    async with AsyncSessionLocal() as db:
        ...
        status_record = await get_latest_availability(db, station_id, fuel_type)  # <-- теперь работает
