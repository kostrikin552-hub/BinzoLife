...
from database.crud import (
    ...
    apply_referral, get_user_by_referral_code, get_user_by_id,
    set_user_timezone, find_nearest_city, save_user_location,
    commit_or_rollback, get_all_active_cities, find_or_create_city_by_query
)
...
async def process_text_city(message: types.Message, state: FSMContext):
    ...
    # Если нажата кнопка «✏️ Написать город текстом» — игнорируем и остаёмся в состоянии
