...
async def help_cmd(message: types.Message):
    text = (
        "📖 **Как BinzoLife сэкономит тебе время и деньги:**\n\n"
        "1️⃣ **Найди АЗС за 10 секунд**\n"
        ...
        "🚀 **Готов начать экономить?** Просто нажми «Найти заправку»!"
    )
