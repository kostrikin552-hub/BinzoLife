# handlers/payments.py — ПОЛНАЯ ФИНАЛЬНАЯ ВЕРСИЯ (с единым send_invoice)
import json
import logging
...
async def send_invoice(
    ...
    """
    Единая функция отправки инвойса с корректным provider_data для 54-ФЗ.
    Поддерживает рубли и Stars.
    """
