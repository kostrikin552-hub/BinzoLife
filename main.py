...
# Фоновые сервисы (без спам-воркеров, но с остальными)
...
# price_alert_worker и pro_reminder_worker отключены (спам-воркеры)
...
async def main():
    ...
    # 5. Polling с ретраями при конфликте
