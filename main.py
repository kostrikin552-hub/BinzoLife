# main.py — ОБНОВЛЁННАЯ ВЕРСИЯ (без emergency-роутера)
import os
import asyncio
import logging
import sys
...
from handlers import (
    start, find, menu, payments, profile, review,
    contest, notifications, common, inline,
)
# ❌ emergency временно отключён
# from handlers import emergency
...
async def main():
    ...
    # Роутеры (без emergency)
    dp.include_router(start.router)
    dp.include_router(find.router)
    # ❌ dp.include_router(emergency.router)  # временно отключено
