...
# ============================================================
# HTTP-СЕРВЕР (ДЛЯ HEALTH И ЗАДАЧ)
# ============================================================
...
# ============================================================
# ФУНКЦИЯ ОБНОВЛЕНИЯ СХЕМЫ БД (ПОЛНАЯ)
# ============================================================
async def ensure_schema_updates():
    ...
    # Создаём таблицы для радара наличия
...
async def on_startup():
    ...
    # Запуск фоновых задач через супервизор
    ...
    asyncio.create_task(supervised_task(data_collector_worker, "data_collector", restart_delay=60))
...
async def main():
    ...
    # Запуск polling с повторными попытками при конфликте
    max_retries = 10
    retry_delay = 5
    for attempt in range(max_retries):
        try:
