...
from handlers import (
    ...
    review, emergency, contest, inline  # добавлен inline
)
...
from services.radar import send_friday_fuel_radar  # добавлен радар
...
dp.include_router(inline.router)  # добавлен
...
# ---------- Загрузка начальных данных (БЕЗ ТЕСТОВЫХ СТАНЦИЙ) ----------
...
async def on_startup():
    ...
    asyncio.create_task(supervised_task(send_friday_fuel_radar, "friday_radar", restart_delay=3600))  # добавлен радар
