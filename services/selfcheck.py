# services/selfcheck.py – ИСПРАВЛЕННАЯ ВЕРСИЯ (без рекурсии, надёжное создание пользователя)
...
class SelfTester:
    def __init__(self):
        ...
        # Используем отрицательные числа, чтобы не конфликтовать с реальными пользователями
        self.test_telegram_ids = [-1000000 - i for i in range(6)]
        self.test_user_ids = []
