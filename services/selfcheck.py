# services/selfcheck.py – ПОЛНЫЙ ИСПРАВЛЕННЫЙ ФАЙЛ
# Исправлены ошибки дублирования ключей (UniqueViolationError) для тестового пользователя и платежа
# Очистка данных отключена для предотвращения ошибок внешнего ключа
...
class SelfTester:
    ...
    # ---------- Проверки с временными пользователями (исправлены дубликаты) ----------
