# services/selfcheck.py – ПОЛНАЯ ФИНАЛЬНАЯ ВЕРСИЯ (с очисткой от угловых скобок)
...
class SelfCheckResult:
    ...
    def add(self, name: str, success: bool, message: str = "", duration: float = 0.0):
        # Очищаем все сообщения от потенциальных HTML-тегов
    ...
    def summary(self) -> str:
        ...
        for name, success, msg, duration in self.checks:
            ...
            # Дополнительная очистка на случай пропущенных символов
